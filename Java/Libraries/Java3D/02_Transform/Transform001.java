/**
 * 2014-05-15
 * @see <a href="http://www.maroon.dti.ne.jp/koten-kairo/works/Java3D/transform2.html">参考</a>
 */
...
public class Transform001 {
	public static void main(String[] args){
		new Transform001("右に寄りし四角き物");
	}
	 ...
	 */
	public Transform001(String title){ /*{{{*/
